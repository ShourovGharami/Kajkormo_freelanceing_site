...
if(isset($_SESSION['username'])){
  ...
  $sql1="SELECT * FROM `client` WHERE status='approved'";
...
<body>
  ...
  <div class="w3-cointer w3-black" style="padding-left: 45%;padding-right: 40%;">
 <h1 class="w3-blue" style="text-shadow:1px 1px 0 #444"> (Client List) </h1>
 </div>
 ...
 <table>
           <tr><th>Freelancer id</th>
               ...
               <th>Email</th>
                ...
                <th>Company</th>
                 <th>Action</th>
           <?php while($client=mysqli_fetch_array($req1)) {?>
           <tr>
               <td><?php echo $client['cid']; ?></td>
               <td><?php echo $client['name']; ?></td>
               <td><?php echo $client['email']; ?></td>
               <td><?php echo $client['company']; ?></td>
               <td><a href="clientdetals-n.php?show=<?php echo $client['cid']; ?>" class="w3-button w3-red">Details</a></td>
